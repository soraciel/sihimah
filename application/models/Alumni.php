	...
	class Alumni extends CI_Model
	{
		...
		public function setNotificationLogin()
		{
			...
			("
				...
				SELECT alumni.NamaLengkap, alumni.TahunLulus, alumni.Lembaga, alumni.LinkFoto, 'Alumni' ,'Telah Login', NOW(), NOW() 
				FROM Alumni
		...
		public function setNotificationLogout()
		{
			...
			("
				INSERT INTO notifikasi (Nama, TahunLulus, Lembaga, LinkFoto, User, Notifikasi, Waktu, Tanggal)
				SELECT alumni.NamaLengkap, alumni.TahunLulus, alumni.Lembaga, alumni.LinkFoto, 'Alumni' ,'Telah Logout', NOW(), NOW() 
				FROM alumni
				WHERE alumni.Username='$this->Username'
				");
			$this->db->close();
		...
		public function setNotificationUpdate()
		{
			...
			("
				INSERT INTO notifikasi (Nama, TahunLulus, Lembaga, LinkFoto, User, Notifikasi, Waktu, Tanggal)
				SELECT alumni.NamaLengkap, alumni.TahunLulus, alumni.Lembaga, alumni.LinkFoto, 'Alumni' ,'Telah Update Data', NOW(), NOW() 
				FROM alumni
				WHERE alumni.Username='$this->Username'
				");
			$this->db->close();
		...
		public function setNotificationUploadPhoto()
		{
			...
			("
				INSERT INTO notifikasi (Nama, TahunLulus, Lembaga, LinkFoto, User, Notifikasi, Waktu, Tanggal)
				SELECT alumni.NamaLengkap, alumni.TahunLulus, alumni.Lembaga, alumni.LinkFoto, 'Alumni' ,'Telah Ganti Foto', NOW(), NOW() 
				FROM alumni
				WHERE alumni.Username='$this->Username'
				");
			$this->db->close();
		...
		public function getFromDatabase()
		{
			...
			$query = $this->db->query
					("
						SELECT Username, NamaLengkap, TahunLulus, LinkFoto
						FROM Alumni
						WHERE 
