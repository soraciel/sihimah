...
<head>
    ...
    <title>Update Data Alumni | SI-HIMAH</title>
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form class="form-horizontal form-label-left" action="../../pilihadmin/do_updatedataalumni" method="POST" enctype="multipart/form-data">
                            ...
                            <input name="alamatUsernameTujuan" type="hidden" value="<?php echo ($Username ? $Username : "");?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <select class="form-control" name="inputCabangLembaga" required="required">
                                                ...
                                                <option <?php echo ($Lembaga=='MA Bendungan Jati Hikmatul Amanah Pacet' ? "selected" : "");?>>MA Bendungan Jati Hikmatul Amanah Pacet</option>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div id="step-2">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea name="inputKuliah" id="inputKuliah" class="form-control" rows="2" placeholder="Kuliah"><?php echo $TempatKuliah; ?></textarea>
                                    </div>
                                </div>
