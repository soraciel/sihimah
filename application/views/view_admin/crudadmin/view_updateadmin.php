...
<head>
    ...
    <title>Update Admin | SI-HIMAH</title>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form class="form-horizontal form-label-left" method="post" action="../../pilihadmin/do_ubahdataadmin">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="inputNama" class="form-control col-md-7 col-xs-12" data-validate-length-range="1,20" name="inputNama" placeholder="" value="<?php echo $Nama; ?>" required="required" type="text" 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="inputAlamatSekarang" class="form-control col-md-7 col-xs-12" data-validate-length-range="1,20" name="inputAlamatSekarang" placeholder="" value="<?php echo $Alamat; ?>" required="required" type="text" 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="inputNoHP" class="form-control col-md-7 col-xs-12" data-validate-length-range="1,20" name="inputNoHP" placeholder="" value="<?php echo $NoHP; ?>" required="required" type="text" 
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="inputUsername" class="form-control col-md-7 col-xs-12" data-validate-length-range="1,10" id="inputUsername" placeholder="" 
                                        value="<?php echo $Username; ?>" name="inputUsername" required="required" readonly="readonly" onfocus="checkNull('inputNoHP', 'confirmMessage2', 'inputNoHP'); return false;"
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input id="inputPassword" type="password" name="inputPassword" data-validate-length-range="1,8" class="form-control col-md-7 col-xs-12" value="<?php echo $Password; ?>" required="required"
