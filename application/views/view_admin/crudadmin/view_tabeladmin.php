...
<head>
    ...
    <title>Tabel Admin | SI-HIMAH</title>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                <a href="../pilihadmin/tambahakunadmin" class="btn btn-primary"><i class="fa fa-plus-square"></i> &nbsp Tambah Admin</a>
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td>
                                                    ...
                                                    <a  onClick="return confirm('Apakah anda yakin ingin menghapus ?')"
                                                        href="../pilihadmin/do_hapusdataadmin/<?php echo  $row->Username; ?>"
