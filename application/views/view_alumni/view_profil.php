...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Profil | SI Himpunan Alumni Amanatul Ummah</title>
  ...
  <body>
	...
	<div class="container">
		  ...
		  <blockquote>              
              ...
              <br>
                  <a href="http://<?php echo ($Facebook ? $Facebook : "");?>" data-toggle="tooltip" title="<?php echo ($Facebook ? $Facebook : "");?>"><img src="../assets2/img/logo-fb.png" width="50px" height="50px"></a>
                  <a href="http://<?php echo ($Twitter ? $Twitter : "");?>" data-toggle="tooltip" title="<?php echo ($Twitter ? $Twitter : "");?>"><img src="../assets2/img/logo-twitter.png" width="50px" height="50px"></a>
        ...
        <li class="active"><a href="#about">Informasi Lanjutan</a></li>
        <li><a href="#prestasi">Prestasi</a></li>
        <li><a href="#orang_tua">Informasi Orang Tua</a></li>
        <li><a href="#kartu">Identity Card <span class="badge badge-important">New</span></a></li>
        <li><a href="#cetak">Print <span class="badge badge-important">New</span></a></li>
    </ul>
