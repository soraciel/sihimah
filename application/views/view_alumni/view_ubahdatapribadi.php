...
<html lang="en">
  ...
  <body>
    ...
    <div class="span2" >
      ...
      <div class="span7">
          <form class="form-horizontal" name="login" action="../pilihalumni/do_ubahdatapribadi" method="post">
      ...
      <div class="accordion-group">
                ...
                <div class="accordion-inner">
                    <div class="span6">
                        ...
                        <div class="control-group">
                            <label class="control-label" for="inputNamaLengkap" style="text-align: left">Nama Lengkap <span style="color:red;">*</span></label>
                            <div class="controls">
                                <input name="inputNamaLengkap" class="input-xlarge" type="text" id="inputNamaLengkap" value="<?php echo ($NamaLengkap ? $NamaLengkap : "");?>" placeholder="Nama Lengkap">
                            </div>
                        </div>
                        <!-- Nama Panggilan -->
                        <div class="control-group">
                            <label class="control-label" for="inputNamaPanggilan" style="text-align: left">Nama Panggilan</label>
                            <div class="controls">
                                <input name="inputNamaPanggilan" class="input-xlarge" type="text" id="inputNamaPanggilan" value="<?php echo ($NamaPanggilan ? $NamaPanggilan : "");?>" placeholder="Nama Panggilan">
                            </div>
                        </div>
            ...
            <!--Tahun Lulus-->
            <div class="control-group">
                            <label class="control-label" for="inputTahunLulus" style="text-align: left">Tahun Lulus <span style="color:red;">*</span></label>
                            
                            <div class="controls">
                                <select name="inputTahunLulus">
                                  <option <?php echo ($TahunLulus=='2018' ? "selected" : "");?>>2018</option>
                                  <option <?php echo ($TahunLulus=='2017' ? "selected" : "");?>>2017</option>
                                  <option <?php echo ($TahunLulus=='2016' ? "selected" : "");?>>2016</option>
                                  <option <?php echo ($TahunLulus=='2015' ? "selected" : "");?>>2015</option>
                                  <option <?php echo ($TahunLulus=='2014' ? "selected" : "");?>>2014</option>
                                  <option <?php echo ($TahunLulus=='2013' ? "selected" : "");?>>2013</option>
                                  <option <?php echo ($TahunLulus=='2012' ? "selected" : "");?>>2012</option>
                                  <option <?php echo ($TahunLulus=='2011' ? "selected" : "");?>>2011</option>
                                  <option <?php echo ($TahunLulus=='2010' ? "selected" : "");?>>2010</option>
                                  <option <?php echo ($TahunLulus=='2009' ? "selected" : "");?>>2009</option>
                                  <option <?php echo ($TahunLulus=='2008' ? "selected" : "");?>>2008</option>
                                  <option <?php echo ($TahunLulus=='2007' ? "selected" : "");?>>2007</option>
                                  <option <?php echo ($TahunLulus=='2006' ? "selected" : "");?>>2006</option>
                                  <option <?php echo ($TahunLulus=='2005' ? "selected" : "");?>>2005</option>
                                  <option <?php echo ($TahunLulus=='2004' ? "selected" : "");?>>2004</option>
                              </select>
                            </div>
                        </div>
            ...
            <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea name="inputAlamatAsal" class="input-xlarge" rows="4" id="inputAlamatAsal" placeholder="Alamat Asal" required><?php echo ($AlamatAsal ? $AlamatAsal : "");?></textarea>
                            </div>
                        </div>
            ...
            <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea name="inputAlamatSekarang" class="input-xlarge" rows="4" id="inputAlamatSekarang" placeholder="Alamat Sekarang" required><?php echo ($AlamatSekarang ? $AlamatSekarang : "");?></textarea>
                            </div>
                        </div>
    ...
    <div class="accordion-group">
            ...
            <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea name="inputKuliah" class="input-xlarge" rows="4" id="inputKuliah" placeholder="Kuliah"><?php echo ($TempatKuliah ? $TempatKuliah : "");?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea name="inputAktifOrganisasi" class="input-xlarge" rows="4" id="inputAktifOrganisasi" placeholder="Aktif Organisasi"><?php echo ($Kesibukan ? $Kesibukan : "");?></textarea>
                            </div>
                        </div>
            ...
            <!-- Bekerja -->
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea name="inputBekerja" class="input-xlarge" rows="4" id="inputBekerja" placeholder="Bekerja"><?php echo ($TempatKerja ? $TempatKerja : "");?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea name="inputHobi" class="input-xlarge" rows="3" id="inputHobi" placeholder="Hobi"><?php echo ($Hobi ? $Hobi : "");?></textarea>
                            </div>
                        </div>
            ...
            <!--Prestasi-->
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <textarea name="inputPrestasi" class="input-xlarge" rows="4" id="inputPrestasi" placeholder="Prestasi"><?php echo ($Prestasi ? $Prestasi : "");?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                 <textarea name="inputCita" class="input-xlarge" rows="3" id="inputCita" placeholder="Cita-cita"><?php echo ($Cita_Cita ? $Cita_Cita : "");?></textarea>
                            </div>
                        </div>              
                        <!-- Motto -->
                        <div class="control-group">   
                            ...
                            <div class="controls">
                                <textarea name="inputMotto" class="input-xlarge" rows="3" id="inputMotto" placeholder="Motto"><?php echo ($Motto ? $Motto : "");?></textarea>
                            </div>
                        </div>
                    </div>
                </div>
