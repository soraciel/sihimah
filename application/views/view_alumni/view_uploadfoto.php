      ...
      <div class="navbar navbar-fixed-top">
        <div class="navbar-inner">
          <div class="container">
            ...
            <a class="brand" href="beranda.php"> <img src="../assets2/img/logo-himah.png" width="25px" height="25px"/> SI-HIMAH</a>
			...
			<ul class="nav pull-right">
				...
				<li>
					...
					<ul class="dropdown-menu">
						<li><a href="ubahdatapribadi"><i class="icon-pencil"></i> Mengubah Data</a></li>
		...
		<div class="row">
			<div class="span12">
				<ul class="nav nav-list bs-docs-sidenav">
					...
					<form class="form-search" action="../pilihalumni/uploadfoto" method="post" enctype="multipart/form-data">
						<center>
