			...
			<ul class="nav pull-right">
				...
				<li>
					<form class="form-search nav" method="post" action="carialumni">
						...
						<input name="inputNama" type="text" class="search-query span2" placeholder="Mencari Data Alumni" id="inputNama">
						</div>
					</form>
				</li>
					...
					<?php if($status == 1) {$counter = 0; foreach($query->result() as $row): 
						...
						<tr>
							...
							<td style= "width: 100px;" rowspan="8">
								<center>
									<img src="../../assets2/img/default-foto.png" width="200px" height="200px">
								</center>
							</td>
						</tr>
                        <tr>
						...
						<tr>
							<td style="width: 70px;">
                                <span>
									<a href="https://www.facebook.com/jabiralhayyan"> <img src="../../assets2/img/logo-fb.png" width="30px" height="30px"></a>
								</span> 
                                <span>
									<a href="-"> <img src="../../assets2/img/logo-twitter.png" width="30px" height="30px"></a>
								</span>
                                <span>
									<a href="-"> <img src="../../assets2/img/logo-blog.png" width="30px" height="30px"></a>
								</span>
                            </td>
						</tr>
						';
